      ...
      <div className="lg:flex lg:items-center lg:justify-between mb-10">
        ...
        <div className="mt-5 flex lg:mt-0 lg:ml-4">
          ...
          <span className="sm:ml-3">
            <button
              type="button"
              className="inline-flex items-center rounded-md border border-transparent bg-blue2 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-orange focus:outline-none"
            >
