...
const StyledForm = styled.main.attrs({
  ...
  & {
    ...
    button {
      ${tw`bg-blue2 text-light-grey inline-flex justify-center rounded-md border border-transparent py-2 px-4  mt-2 mb-2 text-sm font-medium  shadow-sm hover:bg-orange focus:outline-none `}
    }
  }
`;
